...
{
  partial class DeliveryOverviewControl
  {
    /// <summary> 
    ...
    private void InitializeComponent()
    {
      ...
      // 
      this.companyBindingSource.DataSource = typeof(Impressio.Models.Company);
      // 
      ...
      // deliveryDateEdit
      // 
      this.deliveryDateEdit.AllowNullInput = DevExpress.Utils.DefaultBoolean.False;
